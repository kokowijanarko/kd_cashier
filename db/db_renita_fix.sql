...
MySQL - 5.5.5-10.1.9-MariaDB : Database - db_renita
*********************************************************************
*/
...
insert  into `inv_inventory`(`inv_id`,`inv_name`,`inv_type_id`,`inv_category_id`,`inv_price`,`inv_stock`,`inv_desc`) values (2,'Kaos sablon warna',1,1,34000,122,'ceking adjah'),(3,'Kaos Sablon Emas dua',2,1,800000,23,'cek cek'),(5,'Mug Mug Mboh',3,2,65000,23,'adasdasd'),(6,'Kaos Pin A',4,1,3400000,11,'asdasdasd'),(8,'Gantungan Kunci aja',4,3,65000,41,'adasdasd');
